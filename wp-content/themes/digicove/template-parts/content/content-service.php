 ...
 */
$archive_readmore_text = digicove()->get_theme_opt( 'archive_readmore_text_service', esc_html__('Read Article', 'digicove') );
?>
<article id="post-<?php the_ID(); ?>" <?php post_class('pxl-item--post pxl-item--archive'); ?>>
    <div class="pxl-item--image">
        <?php if (has_post_thumbnail()) : ?>
            <a href="<?php echo esc_url( get_permalink()); ?>"><?php the_post_thumbnail('digicove-lager'); ?></a>
        <?php endif; ?>
    </div>
    <div class="pxl-item--holder">
        ...
        <div class="pxl-item--readmore">
            <a class="btn btn-gradient" href="<?php echo esc_url( get_permalink()); ?>">
                <?php echo digicove_html($archive_readmore_text); ?>
