...
$sticky_style = digicove()->get_page_opt('sticky_style','default');
$sticky_scroll = digicove()->get_opt('sticky_scroll');
$header_layout = digicove()->get_opt('header_layout');
...
<header id="pxl-header-elementor" class="is-sticky">
    ...
    <?php if(isset($args['header_layout_sticky']) && $args['header_layout_sticky'] > 0) : ?>
        <div class="pxl-header-elementor-sticky <?php echo esc_attr($sticky_style); ?> <?php echo esc_attr($sticky_scroll); ?>">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="pxl-header-menu">
                            <div class="pxl-header-menu-scroll">
                                ...
                                <?php digicove_header_mobile_search_form(); ?>
