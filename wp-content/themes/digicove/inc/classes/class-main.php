...
if (!class_exists('Digicove_Main')) { 
    class Digicove_Main extends Digicove_Base
    {
        ...
        public static function getInstance()
        {
            ...
            if (null === self::$instance) {
                self::$instance = new Digicove_Main();
            }
        ...
        public function get_sidebar(){
            if ( class_exists( 'WooCommerce' ) && (is_product_category() || is_shop() || is_product_tag() || is_product()) ) {
                $sidebar = 'sidebar-shop';
            } elseif( is_singular('page') ) {
                $sidebar = 'sidebar-page';
            } elseif( is_singular('case') ) {
                $sidebar = 'sidebar-case';
...
function digicove() {
    return Digicove_Main::getInstance();
}
// Install
digicove(); 

digicove_action( 'init' );