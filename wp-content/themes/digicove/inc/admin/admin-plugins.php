...
class Digicove_Admin_Plugins extends Digicove_Admin_Page {	
	...
	public function __construct() {
		...
		$this->page_title = esc_html__( 'Install Plugins', 'digicove' );
		$this->menu_title = esc_html__( 'Install Plugins', 'digicove' );
		$this->parent = 'pxlart';
	...
	public function tgmpa_plugin_action( $plugin, $status ) {
		...
		switch( $status ) {
			case 'not-installed':
			$btn_class = 'white';
			$btn_text = esc_html_x( 'Install', 'Plugin installation page.', 'digicove' );
			...
			case 'installed':
			$btn_class = 'success';
			$btn_text = esc_html_x( 'Activate', 'Plugin installation page.', 'digicove' );
			...
			case 'active':
			$btn_class = 'danger';
			$btn_text = esc_html_x( 'Deactivate', 'Plugin installation page.', 'digicove' );
		...
		$btn_text_active = esc_html_x( 'Deactivate', 'Plugin installation page.', 'digicove' );
