<?php
/**
* The Digicove_Admin initiate the theme admin
*/
...
class Digicove_Admin extends Digicove_Base{
    ...
    public function fix_parent_menu() {
		...
		$submenu['pxlart'][0][0] = digicove()->get_name().' '.esc_html__( 'Dashboard', 'digicove' );
