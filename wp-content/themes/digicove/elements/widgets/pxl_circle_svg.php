...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_circle_svg',
        'title' => esc_html__('Circle SVG BR', 'digicove'),
        ...
        'params' => array(
            'sections' => array(  
                array(
                    'name' => 'section_path',
                    'label' => esc_html__('Path Svg', 'digicove' ),
                    'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                    'controls' => array(
                        array(
                            'name' => 'path_svg_text',
                            'label' => esc_html__( 'Path', 'digicove' ),
                        ...
                        array(
                            ...
                            'label' => esc_html__( 'Box Shadow Color', 'digicove' ),
                        ...
                        array( 
                            ...
                            'label' => esc_html__('SVG Height', 'digicove' ),
                ...
                array(
                    'name' => 'section_dot1',
                    'label' => esc_html__('Dot Left', 'digicove' ),
                    'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                    'controls' => array(
                        array(
                            'name' => 'dot1_color_linear',
                            'label' => esc_html__( 'Dot Left Background Linear', 'digicove' ),
                            'type' => \Elementor\Controls_Manager::SWITCHER,
                            'default' => 'true',
                        ),
                        array(
                            'name' => 'dot1_color_one',
                            'label' => esc_html__( 'Dot Left Background Color One', 'digicove' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            'name' => 'dot1_color_two',
                            'label' => esc_html__( 'Dot Left Background Color Two', 'digicove' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                ...
                array(
                    'name' => 'section_dot2',
                    'label' => esc_html__('Dot Right', 'digicove' ),
                    'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                    'controls' => array(
                        array(
                            'name' => 'dot2_color_linear',
                            'label' => esc_html__( 'Dot Right Background Linear', 'digicove' ),
                            'type' => \Elementor\Controls_Manager::SWITCHER,
                            'default' => 'true',
                        ),
                        array(
                            'name' => 'dot2_color_one',
                            'label' => esc_html__( 'Dot Right Background Color One', 'digicove' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            'name' => 'dot2_color_two',
                            'label' => esc_html__( 'Dot Right Background Color Two', 'digicove' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
