...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_team_grid',
        'title' => esc_html__('Team Grid Pxl', 'digicove'),
        'icon' => 'eicon-person',
            ...
            'sections' => array(
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'team',
                            'label' => esc_html__('Team', 'digicove'),
                            ...
                            'controls' => array(
                                ...
                                array(
                                    'name' => 'title',
                                    'label' => esc_html__('Name', 'digicove'),
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'pxl_animate',
                            'label' => esc_html__('Pxl Animate', 'digicove' ),
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'pos_typography',
                            'label' => esc_html__('Position Typography', 'digicove' ),
                            'type' => \Elementor\Group_Control_Typography::get_type(),
                            'control_type' => 'group',
                        ...
                        array(
                            'name' => 'box_min_width',
                            'label' => esc_html__('Box Min Width', 'digicove' ),
                        ...
                        array(
                            'name'  => 'icon_size',
                            'label' => esc_html__( 'Icon Size (px)', 'digicove' ),
                            'type'  => 'slider',
                            'range' => [
                                'px' => [
                                    'min' => 0,
                        ...
                        array(
                            ...
                            'label' => esc_html__('Icon Background Color', 'digicove' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Icon Background Color Hover', 'digicove' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
