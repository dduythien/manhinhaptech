...
if(isset($settings['link']) && !empty($settings['link']) && count($settings['link'])): ?>
    <ul class="pxl-link pxl-link-l1 <?php echo esc_attr($settings['style_l2']); ?> <?php echo esc_attr( $settings['display_style'].' '.$settings['pxl_animate'] ); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
        <?php
                ...
                <a <?php echo implode( ' ', [ $link_attributes ] ); ?>>
                    ...
                    <div class="pxl-link-container">
                        <?php if (!empty($link['text'])) :?>
                            <span class="pxl-link1"><?php echo pxl_print_html($link['text']); ?></span>
                        <?php endif; ?>
                    </div>                        
                </a>
            </li>
