<div class="pxl-icon-box pxl-icon-box1 <?php echo esc_attr( $settings['style']) ?> <?php echo esc_attr( $settings['style_hover']) ?> <?php echo esc_attr($settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
    <div class="pxl-item--inner">
        ...
        <?php if ($settings['style'] == 'style-3') :?>            
            <div class="pxl-item--icon">
                <?php echo esc_attr($settings['icon_number']); ?>            
            </div>            
        <?php endif; ?>
