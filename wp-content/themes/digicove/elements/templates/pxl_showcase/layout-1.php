...
?>
<div class="pxl-showcase layout1 <?php echo esc_attr($settings['active']); ?> <?php if($settings['scroll_effect'] == 'true') { echo 'pxl-showcase-scroll'; } ?> <?php echo esc_attr($settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
                ...
                <?php if(!empty($settings['btn_text1']) || !empty($settings['btn_text2']) ) { ?>
                    <div class="pxl-item--button">
                        <?php if(!empty($settings['btn_text1']) || ! empty($settings['link1']['url'])) { ?>
                            <a class="btn item--link" <?php pxl_print_html($widget->get_render_attribute_string( 'link1' )); ?>>
                                <span><?php echo pxl_print_html($settings['btn_text1']); ?></span>
                            </a>
                        <?php } ?>
                        <?php if(!empty($settings['btn_text2']) || ! empty($settings['link2']['url'])) { ?>
                            <a class="btn item--link" <?php pxl_print_html($widget->get_render_attribute_string( 'link2' )); ?>>
