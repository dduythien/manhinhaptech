<div class="pxl-fancy-box pxl-fancy-box2 <?php echo esc_attr($settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
    <div class="pxl-item--inner">     
        <?php if ($settings['style_hover'] == 'style-hover-1') { ?>
