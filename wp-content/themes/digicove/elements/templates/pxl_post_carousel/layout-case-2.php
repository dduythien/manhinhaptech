...
<?php if (is_array($posts)): ?>
    <div class="pxl-swiper-sliders pxl-case-carousel pxl-case-carousel2 pxl-parent-transition <?php if($center == 'true') { echo 'pxl--swiper-center'; } ?> <?php if($arrows == true) { echo 'pxl-arrows-active'; } ?>">
            ...
            <div <?php pxl_print_html($widget->get_render_attribute_string( 'carousel' )); ?>>
                <div class="pxl-swiper-wrapper">
                    ...
                    foreach ($posts as $post):
                        ...
                        $case_external_link = get_post_meta($post->ID, 'case_external_link', true);                        
                        ?>
                        <div class="pxl-swiper-slide">
                            <?php if (has_post_thumbnail($post->ID) && wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), false)): 
                            $image_size = !empty($img_size) ? $img_size : '370x532';
                    ...
                    <div class="pxl-item--holder ">
                        <h3 class="pxl-item--title">
                            <a href="<?php if(!empty($case_external_link)) { echo esc_url($case_external_link); } else { echo esc_url(get_permalink( $post->ID )); } ?>"><?php echo esc_attr(get_the_title($post->ID)); ?></a>
                        </h3>
                        <?php if(!empty($case_excerpt) && $show_excerpt == 'true'): ?>
                        ...
                        <?php if($show_button == 'true') : ?>
                            <a class="item-readmore" href="<?php if(!empty($case_external_link)) { echo esc_url($case_external_link); } else { echo esc_url(get_permalink( $post->ID )); } ?>">
                                <span class="btn-link">
