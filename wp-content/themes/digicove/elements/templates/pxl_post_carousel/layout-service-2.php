...
<?php if (is_array($posts)): ?>
    <div class="pxl-swiper-sliders pxl-service-carousel pxl-service-carousel2 pxl-parent-transition <?php if($center == 'true') { echo 'pxl--swiper-center'; } ?> <?php if($arrows == true) { echo 'pxl-arrows-active'; } ?>">
                    ...
                    foreach ($posts as $post):
                        ...
                        <div class="pxl-item--inner pxl-not-active <?php echo esc_attr($pxl_animate); ?><?php echo esc_attr($settings['after_service_mix']); ?>" data-wow-duration="1.2s">
                            <div class="pxl-item--holder ">
                                <div class="pxl--image" style="background-image: url(<?php echo wp_kses_post($thumbnail); ?>);">                                    
                                </div>
